...
declare class FolderApi {
    ...
    list<K extends keyof FolderProperties>(pageParam: PageParam<FolderProperties> & FieldsParam<K>): Promise<PageRes<Pick<FolderProperties, K>>>;
    /**
     * 使用特殊的 as_tree 参数来恢复旧的行为
     */
    listAll(): Promise<FolderListRes[]>;
    ...
    notesByFolderId(id: string): Promise<PageRes<NoteGetRes[]>>;
}
